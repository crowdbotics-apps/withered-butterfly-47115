"""
Django settings for withered_butterfly_47115 project.
...
ROOT_URLCONF = 'withered_butterfly_47115.urls'
...
WSGI_APPLICATION = 'withered_butterfly_47115.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_butterfly_47115 API",
    "DESCRIPTION": "API documentation for withered_butterfly_47115 App",
    "VERSION": "v1",
}
